...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="p-8 backdrop-blur-0 bg-gray-900 min-h-screen min-w-max text-white">
        <>
          {getRound()}
          {currentRound && (
            <>
...
function BidPage({ roundId }: { roundId: string }) {
  ...
  return (
    <div>
      ...
      <form onSubmit={handleOnSubmit} className="flex gap-1 flex-col justify-center text-white mt-8">
        <label>
          <input
...
function RoundBids({ roundId }: { roundId: string }) {
  ...
  return (
    <div className="flex flex-col justify-center content-center mt-8">
