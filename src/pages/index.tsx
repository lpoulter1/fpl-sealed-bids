...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen min-w-max flex-col gap-16 bg-gray-900 p-8 text-white md:flex-row">
        <>
          {getRound()}
          {currentRound && (
  ...
  return (
    <div className="flex max-w-lg flex-col">
      ...
      <form
        ...
        className="mt-8 flex w-96 flex-col justify-center gap-3 text-white md:max-w-md"
      >
        <label>
          <input
            className="w-full bg-slate-800  p-6  placeholder-gray-400 focus-visible:outline-none focus-visible:outline-orange-500 rounded-xl"
            name="user"
            placeholder="Your Name"
            required
          />
        </label>
        <label className="focus:outline-orange-500 rounded-xl">
          <input
            className="w-full bg-slate-800 p-6 placeholder-gray-400 focus-visible:outline-none focus-visible:outline-orange-500 rounded-xl"
            name="amount"
