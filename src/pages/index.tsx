...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="flex flex-col items-center md:items-start md:flex-row gap-16 min-h-screen min-w-max bg-gray-900 p-8 text-white">
        <>
          {getRound()}
          {currentRound && (
        ...
        <iframe width={1200} height={500} src="https://docs.google.com/spreadsheets/d/e/2PACX-1vScXgOGg-l5p0SCEQwbllQ3PhCM4kmIko3HccpxEt4LFsg-331YPOv9oeQ84kBulfuw8VK9y-FdC1v8/pubhtml?gid=1073624568&amp;single=true&amp;widget=true&amp;headers=false" />     
      </main>
    </>
  );
};
  ...
  return (
    <div className="flex max-w-lg flex-col">
      ...
      <form
        ...
        className="mt-8 flex w-96 md:max-w-md flex-col justify-center gap-3 text-white"
      >
        <label>
          <input
            className="w-full p-6  bg-slate-800  placeholder-gray-400"
            name="user"
        ...
        <button
          className="mt-2 p-6 rounded bg-slate-800  text-white"
          type="submit"
        >
          Submit Bid
        </button>
