...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col md:gap-16  bg-gray-900 p-8 text-white md:flex-row">
  ...
  return (
    <div className="flex max-w-lg flex-col">
      ...
      <form
        ...
        className="mt-8 flex max-w-96 flex-col justify-center gap-3 text-white md:max-w-md"
      >
        <label>
          <input
